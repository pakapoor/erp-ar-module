...
- (1) POST /invoices -- invoice creation (FR1)
- (2) GET /invoices/{id} -- invoice retrieval (FR1)
- (3) POST /invoices/{id}/approve -- invoice approval + GL entries (FR2)
- (4) POST /payments -- payment recording + allocation (FR4)
...
### (3) POST /invoices/{id}/approve (FR2, FR12, FR13)
