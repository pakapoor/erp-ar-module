...
**Key decisions:**
- No Redis Ñ PostgreSQL owns all financial state, locks, and idempotency
- Modular monolith Ñ invoice + payment + GL share one ACID transaction
- Transactional outbox Ñ delivery committed with invoice, not dependent on SQS
- Zero Trust Ñ JWT validated at both gateway and application layer independently
...
- [Technical Walkthrough](docs/interview-walkthrough.md) Ñ narrative + Q&A
- [Requirements Traceability](docs/requirements-traceability.md) Ñ what is done vs deferred
- [High Level Design](docs/high-level-design.md) Ñ architecture diagrams
- [API Design](docs/api-design.md) Ñ endpoint contracts
- [Data Model](docs/data-model.md) Ñ ER diagrams and schema decisions
- [Design Tradeoffs](docs/tradeoffs.md) Ñ 14 documented decisions
- [Financial Controls](docs/financial-controls.md) Ñ SOX, period close, reconciliation
- [FX Rate Design](docs/fx-rate-design.md) Ñ multi-currency approach
- [Experience Showcase](docs/experience-showcase.md) Ñ Meta + Lenovo context
- [Assessment Submission](docs/assessment-submission.md) Ñ consolidated narrative
- [Deployment Guide](docs/deployment.md) Ñ local setup
- [Test Results](docs/tests.md) Ñ coverage dashboard

---

## Time Investment

The assessment suggested 3-4 hours. I spent a full weekend Ñ financial systems were a new domain and I wanted to genuinely understand the accounting before writing code.
...
AI tools made this depth achievable in the time available Ñ which is the point of encouraging their use.
